...
final readonly class PublicationInventory
{
    ...
    {
        $targets = [];
        foreach (['/', '/index.html', '/404.html', '/llms.txt', '/favicon.svg', '/articles/', '/articles/index.html', '/pages/', '/pages/index.html', '/tags/', '/tags/index.html', '/assets/theme.css', '/assets/theme.js'] as $target) {
            $targets[$target] = true;
        }
