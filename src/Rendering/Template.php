...
enum Template: string
{
    ...
    {
        return match ($this) {
            self::Layout => ['language', 'description', 'author', 'version', 'title', 'canonical', 'social_metadata', 'base_path', 'preloads', 'theme_script', 'theme_stylesheet', 'site_stylesheet', 'site_script', 'sitename', 'navigation', 'body', 'profiles'],
